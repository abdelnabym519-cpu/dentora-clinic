...
هذا المستند يصف سلوك النسخ الاحتياطي والاستعادة التشغيلي للنسخة المحلية المرخصة من Dentora على Windows/Mini PC. هذه ليست مرحلة Documentation / Handover النهائية؛ هي فقط وثائق التشغيل المطلوبة لإغلاق Backup / Restore.
...
هذه المرحلة لا تنفذ **Auto Update** ولا **Client Packaging** ولا Documentation / Handover النهائي ولا Final Release Gate. كل هذه العناصر خارج نطاق Backup / Restore ولا تبدأ قبل إغلاق هذه المرحلة رسميًا.
