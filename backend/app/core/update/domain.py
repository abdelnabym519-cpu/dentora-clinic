...
class UpdateDescriptor:
    ...
    def from_dict(cls, value: Any) -> UpdateDescriptor:
        ...
        compatible_from = value.get("compatible_from")
        ...
        _version_tuple(compatible_from)
        ...
        return cls(version, compatible_from, package_url, sha256, size, schema, requires_backup)
