...
# The SQL adapter lives inside clinical_copilot (beside its port) so the
# copilot consumes second-review artifacts without a reverse dependency on
# this module; re-exported here for the report composition root.
from app.modules.clinical_copilot.infrastructure import (  # noqa: E402
    DatabaseSecondReviewReader,
)
