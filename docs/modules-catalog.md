...
| `dental_3d` | 0.5.0 | official | patients, odontogram, media | manual | yes | 2 | 0 | 0 | yes |
...
Dental 3D — 3D dentition preview on the patient summary with real mesh ingestion (STL/OBJ via the media module), a synthetic fallback and a non-clinical automatic tooth-segmentation foundation with dentist review, plus a non-diagnostic CBCT/DICOM ingestion and normalized data-availability foundation.
