...
| [DentalSegmentator weights](https://zenodo.org/records/10829675) | Operator-managed external asset; not downloaded or redistributed by Dentora. File `Dataset112_DentalSegmentator_v100.zip` (Zenodo record 10829675, DOI 10.5281/zenodo.10829674), recorded zip md5 `b71cd5230168d28a4f71b078265b76be`; provisioned and checksum-verified by `nerve-inference-service/scripts/provision_model.py` | CC BY 4.0 in Zenodo record metadata (independently re-verified against the record metadata and third-party integration audits) | PASS with attribution — deployment must preserve model/version and required attribution (Dot G, et al., J Dentistry 2024, doi:10.1016/j.jdent.2024.105130). |
